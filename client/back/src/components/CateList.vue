            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr v-if="!cates.length">
                        <td colSpan="8" class="center">暂无分类</td>
                    </tr>
                    <tr v-else v-for="cate in cates">
                        <td>
                            <a v-link='{ name: "editCate", params: { id: cate._id} }' title={{cate.name}}>{{cate.name}}</Link>
                        ...
                        <td>
                            <a v-link='{ name: "editCate", params: { id: cate._id} }'>
                            ...
                            <button v-if="showEditAndDel" type="button" @click="deleteCate(cate._id)" class="btn btn-danger btn-xs">
